...
- **M5 — Phase 15 as planned.** Electron + local model. M0–M4 make it a stronger foundation to package. *Detailed plan: see GURU-AND-ONBOARDING-PLAN.md (Pratham O1–O7: packaging, bundled Gemma, search tier, wizard, keyring, permission rings).*
- **M6 — Guru (teach panel v2).** *Detailed plan: GURU-AND-ONBOARDING-PLAN.md (G1–G5: concept decomposition, LLM-backed artifacts, mastery loop, Gurukul panel, spaced repetition).*
