...
- [ ] Per-profile scoping of the system views (learned patterns, the Karma audit, the Andon log, audit search) and of generated artifacts is merged. Until it is, those views can show short task descriptions from other profiles.
